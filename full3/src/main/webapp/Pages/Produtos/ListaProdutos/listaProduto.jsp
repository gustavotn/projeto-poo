...
<head>
    <meta charset="UTF-8">
    <title>LGC</title>
    <link href="http://localhost:8080/lgc-web/Pages/Produtos/ListaProdutos/style.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div id="container">
        <h2>Produtos</h2>
       <form action="../../../ListaProdutos" method="get" class="testes">
			...
			<%if(request.getAttribute("produtos") != null){
	           ...
	           <div class="product">
	               ...
	               <img src="http://localhost:8080/lgc-web/Images/hamburguer.png">
